...
function UsersManagement() {
  ...
  const fetchUserListing = async () => {
    try {
      ...
      const response = await fetch(
        "https://fyp-37p-api-a16b479cb42b.herokuapp.com/auth/admin_get_all_users",
        {
          method: "GET",
          headers: {
      ...
      if (data.successful && Array.isArray(data.users)) {
        ...
        console.error(
          "Expected 'users' to be an array but got",
          typeof data.users
        );
      }
    } catch (err) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://fyp-37p-api-a16b479cb42b.herokuapp.com/auth/admin_update_user",
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const suspendUser = async (user) => {
    ...
    try {
      const response = await fetch(
        "https://fyp-37p-api-a16b479cb42b.herokuapp.com/auth/admin_block_user",
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
