  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://asterheng-github-io.onrender.com/send_email",
        {
          method: "POST",
        ...
        <Box>
          ...
          <div className="container my-5" style={{ marginTop: "100px" }}>
            ...
            <form onSubmit={handleSubmit}>
              <p>
                We will pass your question on to our admin who will personally
                reply to you as soon as poosible.
              </p>
              <input
                type="email"
                name="recipient"
              ...
              />
              <p class="small-text3">
                Please enter the details of you requrest. An admin of our
                support will response as soon as possible.
              </p>
