...
function Two2FAVerification({
  ...
  const handleTokenLogin = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://fyp-37p-api-a16b479cb42b.herokuapp.com/auth/confirm_login",
        {
          method: "POST",
          headers: {
  ...
  const handleTokenVerification = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://fyp-37p-api-a16b479cb42b.herokuapp.com/auth/confirm_registration",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleReset = async () => {
    try {
      const response = await fetch(
        "https://fyp-37p-api-a16b479cb42b.herokuapp.com/auth/change_totp",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    <form onSubmit={handleSubmit}>
      ...
      {forgotPasswordEmail ? (
        <p className="text-center text-gray-600 text-lg font-light">
          Please enter your new password, confirm new password and 6-digit Time
          Based OTP to change your password
        </p>
      ) : (
        <p className="text-center text-gray-600 text-lg font-light">
